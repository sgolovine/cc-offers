...
export const creditCardOffers = sqliteTable(
  "credit_card_offers",
  {
    ...
    spendTimeframeDaysTier1: text("spend_timeframe_days_tier_1"),
    spendRequirementTiming: text("spend_requirement_timing"),
    baseAnnualFeeUsd: integer("base_annual_fee_usd"),
    additionalUserAnnualFeeUsd: integer("additional_user_annual_fee_usd"),
    additionalRequirementsAnnualFee: text("additional_requirements_annual_fee"),
    ...
    spendRequirementExtraReqs: text("spend_requirement_extra_reqs"),
    bonusMilesType: text("bonus_miles_type"),
    spendTimeframeDaysTier2: text("spend_timeframe_days_tier_2"),
    cashBonusType: text("cash_bonus_type"),
  },
  (table) => [
